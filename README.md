...
- [Часть 1: Основы Backend разработки](#-часть-1-основы-backend-разработки)
    ...
    - [Операционные системы](#-3-операционные-системы)
    - [Принципы программирования](#-4-принципы-программирования)
- [Практические вопросы для подготовки](#-практические-вопросы-для-подготовки)
- [Часть 2: Базы данных и DevOps](#-часть-2-базы-данных-и-devops)
